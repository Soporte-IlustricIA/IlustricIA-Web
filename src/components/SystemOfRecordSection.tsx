  ...
  return (
    <section className="w-full bg-transparent py-20 px-4 md:px-8 relative overflow-x-clip">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Header Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12 relative items-center min-h-[600px]">
          <div className="flex flex-col justify-center z-10">
            ...
            <div className="flex flex-wrap items-center gap-6">
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="px-10 py-5 bg-white/50 dark:bg-neutral-900/50 backdrop-blur-md text-black dark:text-white border border-neutral-200 dark:border-neutral-700 rounded-xl text-base font-bold hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all flex items-center gap-3"
              >
          ...
          <div className="relative h-[500px] lg:h-[700px] flex items-center justify-center">
            <div className="absolute w-[800px] h-[800px] lg:w-[1000px] lg:h-[1000px] pointer-events-none opacity-100 mix-blend-screen z-0 translate-x-[15%]">
               <SystemGlobe />
            </div>
          </div>
        </div>
